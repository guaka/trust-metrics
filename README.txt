...
The code is written in Python and is available under the GPLv2+.  It
is be based a few existing free software projects, such as:
...
project home: http://trustlet.org
code home: http://trust-metrics.googlecode.com/
